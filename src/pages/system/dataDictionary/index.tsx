...
export default (): React.ReactNode => {
    ...
    const { loading, itemList, getDataDictionary, getDataDictionaryLoad, addDataDictionary, editDataDictonary, delDataDictionary } = useModel('dataDictionaryServices');
    ...
    const [loadDataDictionary, setLoadDataDictionary] = useState<{ parentId?: string; }>({});
        ...
        >
            ...
            <Form {...modalFormLayout} form={modalForm}>
                ...
                <Form.Item name='remark'
                    label={intl.formatMessage({ id: 'datadictionary.modal.form.item.remark.label' })}
                >
                    <Input allowClear placeholder={intl.formatMessage({ id: 'datadictionary.modal.form.item.remark.input.placeholder' })} />
                </Form.Item>
                <Form.Item name='sort'
                    label={intl.formatMessage({ id: 'datadictionary.modal.form.item.sort.label' })}
                >
