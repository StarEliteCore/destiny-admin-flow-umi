...
import { getFakeCaptcha } from '@/apis/login';
...
const LoginItem: React.FC<LoginItemProps> = (props) => {
  ...
  const { onChange, customProps, defaultValue, rules, name, getCaptchaButtonText, getCaptchaSecondText, updateActive, type, tabUtil, ...restProps } = props;
...
Object.keys(ItemMap).forEach((key) => {
  ...
  LoginItems[key] = (props: LoginItemProps) => <LoginContext.Consumer>{(context) => <LoginItem customProps={item.props} rules={item.rules} {...props} type={key} {...context} updateActive={context.updateActive} />}</LoginContext.Consumer>;
});
